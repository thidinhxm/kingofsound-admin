...
function initModels(sequelize) {
  ...
  var reweiws = _reweiws(sequelize, DataTypes);
  ...
  products.belongsToMany(users, { as: 'user_id_users_reweiws', through: reweiws, foreignKey: "product_id", otherKey: "user_id" });
  ...
  users.belongsToMany(products, { as: 'product_id_products_reweiws', through: reweiws, foreignKey: "user_id", otherKey: "product_id" });
  ...
  reweiws.belongsTo(products, { as: "product", foreignKey: "product_id"});
  products.hasMany(reweiws, { as: "reweiws", foreignKey: "product_id"});
  ...
  reweiws.belongsTo(users, { as: "user", foreignKey: "user_id"});
  users.hasMany(reweiws, { as: "reweiws", foreignKey: "user_id"});
