...
function initModels(sequelize) {
  ...
  var reveiws = _reveiws(sequelize, DataTypes);
  ...
  products.belongsToMany(users, { as: 'user_id_users_reveiws', through: reveiws, foreignKey: "product_id", otherKey: "user_id" });
  ...
  users.belongsToMany(products, { as: 'product_id_products_reveiws', through: reveiws, foreignKey: "user_id", otherKey: "product_id" });
  ...
  reveiws.belongsTo(products, { as: "product", foreignKey: "product_id"});
  products.hasMany(reveiws, { as: "reveiws", foreignKey: "product_id"});
  ...
  reveiws.belongsTo(users, { as: "user", foreignKey: "user_id"});
  users.hasMany(reveiws, { as: "reveiws", foreignKey: "user_id"});
